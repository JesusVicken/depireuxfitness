                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6 mt-10 lg:mt-0" data-aos="fade-up-left" data-aos-delay="300">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <a
                                target="_blank"
                                href={`https://wa.me/5561998219177?text=Olá Cristiano! Gostaria de agendar uma aula experimental personalizada.`}
                            ...
                            <a
                                target="_blank"
                                href={`https://wa.me/5561998219177?text=Olá Cristiano! Quero entrar no grupo de treinos ou saber mais sobre seu trabalho.`}
