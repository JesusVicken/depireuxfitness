...
const services = [
    {
        ...
        description:
            'Aulas focadas na sua evolução física com acompanhamento individual. Ideal para quem quer ganhar força, mobilidade e consciência corporal.',
        duration: 'Flexível conforme sua agenda',
        icon: <Users className="w-6 h-6 text-white" />,
        linkText:
            'Olá Cristiano! Gostaria de mais informações sobre os treinos presenciais personalizados.',
        image: treinoPresencial,
    },
    {
        title: 'Treinos Online e Acompanhamento',
        description:
            'Treinos via vídeo com planos ajustados ao seu ritmo, para você evoluir de qualquer lugar com segurança e orientação profissional.',
    ...
    },
    {
        ...
        description:
            'Fortaleça seu corpo e melhore sua performance para remar melhor na canoa, com exercícios específicos de mobilidade e força.',
    ...
    },
    {
        ...
        description:
            'Práticas que ajudam a liberar tensões, aumentar a flexibilidade e promover bem-estar físico e mental, com foco na qualidade de vida.',
    ...
    },
    {
        ...
        description:
            'Treinos focados em força, resistência e desempenho físico, com acompanhamento para melhorar sua performance e saúde geral.',
